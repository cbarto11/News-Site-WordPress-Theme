 ...
 *
 */
class Exchange_SidebarAdminPage
{
	...
	public function show_page()
	{
		...
		$sidebar_stories_options = new Exchange_SidebarStoriesOptions;
		$options = $sidebar_stories_options->get_options();
	...
	private function process_post()
	{
		...
		$sidebar_stories_options = new Exchange_SidebarStoriesOptions;
		$sidebar_stories_options->save_options( $options );
	}
}
